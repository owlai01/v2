...
if (m.quoted.message) {
            ...
            if (/video/.test(type)) {
               ...
               await client.sendMessage(m.chat, { video: media, caption: `Retrieved by Nairobi tech bot 🇰🇪\nOriginal caption: ${q.caption}`}, { quoted: m})

            } else if (/image/.test(type)) {

await client.sendMessage(m.chat, { image: media, caption: `Retrieved by Nairobi tech bot 🇰🇪\nOriginal caption: ${q.caption}`}, { quoted: m})
